...
#     def courseList(self,number_of_courses):
...
#                     self.marks = self.MarkInput()
#                     for student_name,mark in self.marks.items():
